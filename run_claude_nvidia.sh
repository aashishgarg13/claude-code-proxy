...
echo "=========================================="
echo " Starting Claude Code with NVIDIA NIM..."
echo "=========================================="
...
echo "Starting LiteLLM proxy with NVIDIA Llama 3 70B..."
litellm --config litellm_config_nvidia.yaml > litellm_proxy.log 2>&1 &
LITELLM_PID=$!
